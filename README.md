...
> [!NOTE]
> There is a different HSDSnake version v3.1 (under testing) in [developement branch](https://github.com/zx0223winner/HSDSnake/blob/development/README.md) targting for customized non-model species, such as those annotated via Augustus not just for NCBI download only.
